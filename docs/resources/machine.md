...
<!-- schema generated from machine.md.tmpl. Needs to be kept up to date manually. -->
## Schema
...
- `id_path` (String) The ID path of the block device.
- `model` (String) The model of the block device.
- `name` (String) The block device name.
- `size_gigabytes` (Number) The size of the block device (in GB).
